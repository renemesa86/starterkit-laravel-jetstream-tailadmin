<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
  <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <button
        class="hamburguer z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm 
        dark:border-strokedark dark:bg-boxdark lg:hidden"
       >
        <span class="relative block h-5.5 w-5.5 cursor-pointer">
          <span class="du-block absolute right-0 h-full w-full">
          <span class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white !w-full delay-300" :class="{ '!w-full delay-300': !sidebarToggle }"></span>
          <span class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white !w-full delay-400" :class="{ '!w-full delay-400': !sidebarToggle }"></span>
          <span class="relative top-0 left-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white !w-full delay-500" :class="{ '!w-full delay-500': !sidebarToggle }"></span>
          </span>
      ...
      <a class="block flex-shrink-0 lg:hidden" href="index.html">
        <img src="{{ asset('storage/images/logo/logo-icon.svg') }}" alt="Logo" />
      </a>
    </div>
    ...
    <div class="flex items-center gap-3 2xsm:gap-7">
      <ul class="flex items-center gap-2 2xsm:gap-4">
        ...
        <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" >
          <a class="menu relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
          ...
          <!-- Dropdown Start -->
          <div 
            class="dropdown hidden absolute -right-27 mt-1 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80">
        ...
        <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
          ...
          <!-- Dropdown Start -->
          <div
            class="dropdown hidden absolute -right-16 mt-1 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80"
            >
            <div class="px-4.5 py-3">
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  ...
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('storage/images/user/user-02.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('storage/images/user/user-01.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('storage/images/user/user-03.png')}}" alt="User" />
                  </div>
              ...
              <li>
                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                  href="messages.html">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ asset('storage/images/user/user-04.png')}}" alt="User" />
                  </div>
      ...
      <!-- User Area -->
      <div class="relative">
        <a class="flex items-center gap-4 menu" href="#" id="userarea">
        ...
        <!-- Dropdown Start -->
        <div  
          class="dropdown  hidden absolute right-0 mt-1 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
